...
!*/
g.addTest("svg",!!t.createElementNS&&!!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect);var T=v.testStyles=c;/*!
{
...
!*/
g.addTest("checked",function(){return T("#modernizr {position:absolute} #modernizr input {margin-left:10px} #modernizr :checked {margin-left:20px;display:block}",function(e){var t=s("input");return t.setAttribute("type","checkbox"),t.setAttribute("checked","checked"),e.appendChild(t),20===t.offsetLeft})}),/*!
{
  "name": "time Element",
  "property": "time",
  "tags": ["elem"],
...
!*/
g.addTest("time","valueAsDate"in s("time"));var x=v._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""];v._prefixes=x,/*!
{
  "name": "Touch Events",
